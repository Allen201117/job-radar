...
// running 是 create_crawl_run 的占位符（迁移 234）：同一个值有两种含义，差别只在时间——
// 刚开跑 = 真的在抓；过了宽限期还是它 = 那轮进程死了，这个源就地失踪。
// 宽限期与 crawler/ops_watchdog.UNFINISHED_CRAWL_HOURS 同口径，改一处要两处同改。
const RUN_UNFINISHED_GRACE_MS = 6 * 60 * 60 * 1000;
