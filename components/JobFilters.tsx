...
// 校招/实习的「经验」只有「应届无经验」才有筛选意义；其它年限档会把社招语境带进专区。
const CAMPUS_EXPERIENCE = EXPERIENCE.slice(0, 2);
...
export default function JobFilters({
  ...
  const experienceOptions = lockedJobType ? CAMPUS_EXPERIENCE : EXPERIENCE;
