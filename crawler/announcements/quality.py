...
_TITLE_PROCESS = re.compile(
    ...
    r"专业测试|技能测试|综合测试|体能测评|面试的?公告|面试确认|面试人选|进入面试|面试有关|"
    r"笔试公告|笔试时间|考试时间|考场|领取准考证|考试大纲|大纲解读|费用减免|缴费的?公告|"
    # 2026-09-18 接入宁夏/西藏/内蒙古时漏进来的几类：报名进度播报、名额调整、改报。
    r"报名情况|减少招聘人数|核减.{0,6}(?:计划|人数|岗位)|改报岗位|"
