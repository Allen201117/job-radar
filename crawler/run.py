...
from adapters.zto import ZtoAdapter, ZtoCampusAdapter
...
ADAPTERS = {
    ...
    # 中通自建门户 hr.zto.com：列表+详情公开接口（网关在 recruiting.gw.zt-express.com）。
    # 台账曾判 no_stable_jd，实为误判——详情页 /position-detail?id= 冷加载可渲染。
    "zto": ZtoAdapter(),
    "zto_campus": ZtoCampusAdapter(),
...
_HTTPX_SAFE_ADAPTERS = {
    "apple", "apple_cn", "baidu", "jd", "haier", "iguopin", "siemens", "tencent", "tencent_campus", "huawei_campus", "lixiang_campus", "bilibili_campus", "netease_campus", "alibaba_campus_portal", "hikvision",
