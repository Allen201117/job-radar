...
const NON_SOFTWARE_ENG_DOMAIN =
  /机械|机电|机加|钣金|工艺|化工|化学|材料|冶金|铸造|锻造|焊接|焊工|模具|注塑|液压|气动|数控|机床|刀具|工装|夹具|热处理|土木|结构工程|岩土|暖通|给排水|管道|强电|工业工程|生产工艺|制造工艺|工艺技术|纺织|印染|涂装|总装|冲压|车身|底盘|发动机|动力总成|整车|工业自动化|机械自动化|热设计|散热|结构设计|精密仪器|仪器仪表|光学|镜头|声学|射频|天线|电源|电池|电芯|储能|逆变|试剂|生物|医疗器械|临床|药物|制药|检测认证|可靠性|环境试验|工业设计|包装设计|技术文档|标准化|生产|制造|车间|产线|装配|组装|操作工|技工|班组长|领班|工段|钳工|电工|铣工|车工|设备维护|设备维修|保养|production|manufactur\w*|assembler|operator|machinist|technician|maintenance|fabrication|welding|tooling|transmission|mechanic|质量|品控|品管|质检|检验员|检测|ehs|环保|安全员|职业健康|\bqa\b|\bqc\b|\bsqe\b|quality|safety|inspection/i;

// 生产制造归类专用：只放官方字典归属制造的传统工程、产线与质量安全词，不含土木/临床/生物医药。
const MANUFACTURING_DOMAIN =
  /生产|制造|车间|产线|装配|组装|操作工|技工|班组长|领班|工段|钳工|电工|焊工|铣工|车工|设备维护|设备维修|保养|production|manufactur\w*|assembler|operator|machinist|technician|maintenance|fabrication|welding|tooling|机械|机电|机加|钣金|工艺|化工|化学|材料|冶金|铸造|锻造|焊接|模具|注塑|液压|气动|数控|机床|刀具|工装|夹具|热处理|纺织|印染|涂装|总装|冲压|车身|底盘|发动机|动力总成|整车|电气|自动化|强电|仪器仪表|热设计|散热|射频|天线|电源|电池|电芯|储能|逆变|光学|镜头|声学|精密仪器|工业工程|生产工艺|制造工艺|工艺技术|工业自动化|机械自动化|包装设计|标准化|检测认证|环境试验|transmission|mechanic|质量|品控|品管|质检|检验员|可靠性|质量体系|管理体系|体系工程师|体系专员|体系认证|认证|检测|ehs|环保|安全员|职业健康|\bqa\b|\bqc\b|\bsqe\b|quality|safety|inspection/i;
...
const JOB_FUNCTION_RULES = [
  ...
  ["建筑工程", /建筑师|钢结构|混凝土|建筑结构|水工结构|桥梁|土木|土建|道路|隧道|市政|岩土|勘察|暖通|给排水|供变电|幕墙|装饰|施工|监理|造价|预算员|建筑设计|(?:高速|公路)\s*项目|architectural|landscape\s*architect|construction|site\s*engineer|civil\s*engineer/i],
  ...
  ["医疗健康", /医生|医师|护士|护理|药师|药剂|临床数据|临床|\bcra\b|\bcrc\b|\bcta\b|医学|医药|药物|制药|药品|药理|检验科|放射|影像|超声|口腔|中医|兽医|营养师|康复|理疗|\bmsl\b|医学事务|医疗器械|试剂|生物制药|生物医药|medical|clinical|nurse|pharmac\w*|physician|therapist|biolog\w*|pathology/i],
  ...
  ["客服服务", /客服|客户服务|客户支持|售后|服务专员|服务顾问|话务|坐席|门店|店长|店员|导购|收银|前台|接待|服务员|咖啡师|调茶师|运动顾问|零售|customer\s*service|customer\s*support|customer\s*success|front\s*desk|receptionist|barista|cashier|retail\s*associate/i],
