-- 040 — 扩源（探活器 probe.py live 探活通过，仅含真返回岗位的源）
-- 带 segment(模块)+industry(行业)。Idempotent: guarded by source_url.

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Airbnb', 'https://boards-api.greenhouse.io/v1/boards/airbnb/jobs?content=true', 'official', 'greenhouse', 'http', 'foreign', '互联网·旅行', 'Airbnb（互联网·旅行，probe live 探活 在华 13 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Bosch 博世', 'https://api.smartrecruiters.com/v1/companies/BoschGroup/postings?limit=100', 'official', 'smartrecruiters', 'http', 'foreign', '汽车·工业', 'Bosch 博世（汽车·工业，probe live 探活 在华 9 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'NVIDIA', 'https://nvidia.wd5.myworkdayjobs.com/wday/cxs/nvidia/NVIDIAExternalCareerSite/jobs', 'official', 'workday', 'http', 'foreign', '半导体·AI', 'NVIDIA（半导体·AI，probe live 探活 在华 494 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Pfizer 辉瑞', 'https://pfizer.wd1.myworkdayjobs.com/wday/cxs/pfizer/PfizerCareers/jobs', 'official', 'workday', 'http', 'foreign', '医药', 'Pfizer 辉瑞（医药，probe live 探活 在华 189 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Citi 花旗', 'https://citi.wd5.myworkdayjobs.com/wday/cxs/citi/2/jobs', 'official', 'workday', 'http', 'foreign', '金融', 'Citi 花旗（金融，probe live 探活 在华 48 岗）'
where not exists (select 1 from sources where source_url = 'https://citi.wd5.myworkdayjobs.com/wday/cxs/citi/2/jobs');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Mastercard 万事达', 'https://mastercard.wd1.myworkdayjobs.com/wday/cxs/mastercard/CorporateCareers/jobs', 'official', 'workday', 'http', 'foreign', '金融·支付', 'Mastercard 万事达（金融·支付，probe live 探活 在华 12 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'HSBC', 'https://hsbc.eightfold.ai/api/apply/v2/jobs?domain=hsbc.com', 'official', 'eightfold', 'http', 'foreign', 'discover', 'HSBC（discover，probe live 探活 在华 473 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'AstraZeneca', 'https://astrazeneca.eightfold.ai/api/apply/v2/jobs?domain=astrazeneca.com', 'official', 'eightfold', 'http', 'foreign', 'discover', 'AstraZeneca（discover，probe live 探活 在华 9 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Airbnb', 'https://boards-api.greenhouse.io/v1/boards/Airbnb/jobs?content=true', 'official', 'greenhouse', 'http', 'foreign', 'discover', 'Airbnb（discover，probe live 探活 在华 13 岗）'
where not exists (select 1 from sources where source_url = 'https://boards-api.greenhouse.io/v1/boards/Airbnb/jobs?content=true');
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'Flexport', 'https://boards-api.greenhouse.io/v1/boards/flexport/jobs?content=true', 'official', 'greenhouse', 'http', 'foreign', 'discover', 'Flexport（discover，probe live 探活 在华 5 岗）'
