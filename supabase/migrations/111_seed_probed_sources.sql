-- 111 — 扩源（探活器 probe.py live 探活通过，仅含真返回岗位的源）
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '长城汽车', 'https://gwm.hotjob.cn/wt/GWM/web/index', 'official', 'wt', 'http', 'private', '汽车', '长城汽车（汽车，probe live 探活 在华 3286 岗）'
where not exists (select 1 from sources where source_url = 'https://gwm.hotjob.cn/wt/GWM/web/index');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '内蒙古伊利实业集团', 'https://yili.hotjob.cn/wt/yili/web/index', 'official', 'wt', 'http', 'private', '食品', '内蒙古伊利实业集团（食品，probe live 探活 在华 876 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '新疆特变电工集团', 'https://tbea.hotjob.cn/wt/TBEA/web/index', 'official', 'wt', 'http', 'private', '电气', '新疆特变电工集团（电气，probe live 探活 在华 1521 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '浙江华友钴业', 'https://huayou.hotjob.cn/wt/HUAYOU/web/index', 'official', 'wt', 'http', 'private', '锂电', '浙江华友钴业（锂电，probe live 探活 在华 398 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '中伟新材料', 'https://cngr.hotjob.cn/wt/CNGR/web/index', 'official', 'wt', 'http', 'private', '锂电', '中伟新材料（锂电，probe live 探活 在华 493 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '云南白药', 'https://ynby.hotjob.cn/SU6136b970bef57c3b638162c4/pb/school.html', 'official', 'hotjob', 'http', 'private', '中药', '云南白药（中药，probe live 探活 在华 18 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '用友网络', 'https://yonyou.hotjob.cn/wt/yonyou/web/index', 'official', 'wt', 'http', 'private', '软件', '用友网络（软件，probe live 探活 在华 311 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '立讯精密', 'https://luxshare.hotjob.cn/wt/LUXSHARE/web/index', 'official', 'wt', 'http', 'private', '智能制造', '立讯精密（智能制造，probe live 探活 在华 572 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select 'TCL科技', 'https://tcl.hotjob.cn/wt/TCL/web/index', 'official', 'wt', 'http', 'private', '显示面板', 'TCL科技（显示面板，probe live 探活 在华 1508 岗）'
where not exists (select 1 from sources where source_url = 'https://tcl.hotjob.cn/wt/TCL/web/index');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '伊利股份', 'https://yili.hotjob.cn/wt/yili/web/index', 'official', 'wt', 'http', 'private', '食品', '伊利股份（食品，probe live 探活 在华 876 岗）'
where not exists (select 1 from sources where source_url = 'https://yili.hotjob.cn/wt/yili/web/index');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '飞鹤', 'https://feihe.hotjob.cn/wt/feihe/web/index', 'official', 'wt', 'http', 'private', '食品', '飞鹤（食品，probe live 探活 在华 31 岗）'
where not exists (select 1 from sources where source_url = 'https://feihe.hotjob.cn/wt/feihe/web/index');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '中国飞鹤', 'https://feihe.hotjob.cn/wt/feihe/web/index', 'official', 'wt', 'http', 'private', '食品', '中国飞鹤（食品，probe live 探活 在华 31 岗）'
where not exists (select 1 from sources where source_url = 'https://feihe.hotjob.cn/wt/feihe/web/index');
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '中联重科', 'https://zoomlion.hotjob.cn/wt/zoomlion/web/index', 'official', 'wt', 'http', 'private', '工程机械', '中联重科（工程机械，probe live 探活 在华 864 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '格科微', 'https://galaxycore.hotjob.cn/wt/GALAXYCORE/web/index', 'official', 'wt', 'http', 'private', '半导体', '格科微（半导体，probe live 探活 在华 135 岗）'
where not exists (select 1 from sources where source_url = 'https://galaxycore.hotjob.cn/wt/GALAXYCORE/web/index');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '中伟新材', 'https://cngr.hotjob.cn/wt/CNGR/web/index', 'official', 'wt', 'http', 'private', '锂电', '中伟新材（锂电，probe live 探活 在华 493 岗）'
where not exists (select 1 from sources where source_url = 'https://cngr.hotjob.cn/wt/CNGR/web/index');
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '格科微电子', 'https://galaxycore.hotjob.cn/wt/GALAXYCORE/web/index', 'official', 'wt', 'http', 'private', '半导体', '格科微电子（半导体，probe live 探活 在华 135 岗）'
where not exists (select 1 from sources where source_url = 'https://galaxycore.hotjob.cn/wt/GALAXYCORE/web/index');
