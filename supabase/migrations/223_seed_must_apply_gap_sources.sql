...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, board, regions, notes)
select '壳牌', 'https://shell.wd3.myworkdayjobs.com/wday/cxs/shell/shellcareers/jobs', 'official', 'workday', 'http',
       'foreign', '能源/化工', 'mixed', '{CN}',
