-- 124 — 扩源（探活器 probe.py live 探活通过，仅含真返回岗位的源）
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '神州数码集团', 'https://digitalchina.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '科技', '神州数码集团（科技，probe live 探活 229 岗）'
where not exists (select 1 from sources where source_url = 'https://digitalchina.zhiye.com/social');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '神州数码集团', 'https://digitalchina.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '科技', '神州数码集团（科技，probe live 探活 101 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '扬子江药业集团', 'https://yangzijiang.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '医药', '扬子江药业集团（医药，probe live 探活 326 岗）'
where not exists (select 1 from sources where source_url = 'https://yangzijiang.zhiye.com/social');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '扬子江药业集团', 'https://yangzijiang.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '医药', '扬子江药业集团（医药，probe live 探活 106 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '河南双汇投资发展', 'https://shuanghui.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '食品', '河南双汇投资发展（食品，probe live 探活 47 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '新华三信息技术', 'https://h3c.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '通信', '新华三信息技术（通信，probe live 探活 48 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '深圳市东阳光实业发展', 'https://hec.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '医药', '深圳市东阳光实业发展（医药，probe live 探活 50 岗）'
where not exists (select 1 from sources where source_url = 'https://hec.zhiye.com/campus');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '海天塑机集团', 'https://haitian.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '装备制造', '海天塑机集团（装备制造，probe live 探活 222 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '国轩高科', 'https://gotion.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '锂电', '国轩高科（锂电，probe live 探活 348 岗）'
where not exists (select 1 from sources where source_url = 'https://gotion.zhiye.com/social');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '国轩高科', 'https://gotion.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '锂电', '国轩高科（锂电，probe live 探活 431 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '新易盛', 'https://eoptolink.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '光通信', '新易盛（光通信，probe live 探活 59 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '迈瑞医疗', 'https://mindray.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '医疗器械', '迈瑞医疗（医疗器械，probe live 探活 202 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '信达生物', 'https://innoventbio.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '生物医药', '信达生物（生物医药，probe live 探活 109 岗）'
where not exists (select 1 from sources where source_url = 'https://innoventbio.zhiye.com/campus');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '药明康德', 'https://wuxiapptec.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '医药外包', '药明康德（医药外包，probe live 探活 491 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '金风科技', 'https://goldwind.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '新能源', '金风科技（新能源，probe live 探活 87 岗）'
where not exists (select 1 from sources where source_url = 'https://goldwind.zhiye.com/social');

insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '东鹏饮料', 'https://dongpeng.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '食品饮料', '东鹏饮料（食品饮料，probe live 探活 20 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '泡泡玛特', 'https://popmart.zhiye.com/social', 'official', 'beisen', 'playwright', 'private', '潮玩', '泡泡玛特（潮玩，probe live 探活 131 岗）'
...
insert into sources (company, source_url, source_type, adapter_name, crawl_method, segment, industry, notes)
select '容百科技', 'https://ronbay.zhiye.com/campus', 'official', 'beisen', 'playwright', 'private', '锂电', '容百科技（锂电，probe live 探活 111 岗）'
