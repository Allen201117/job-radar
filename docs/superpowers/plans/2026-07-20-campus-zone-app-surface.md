...
const { campusAdmission } = require("../lib/campus-zone.js");
...
const { recruitmentCategory } = require("./china-keyword-expansion.js");
...
module.exports = { campusAdmission };
```
...
```javascript
const { windowStatus } = require("../lib/campus-zone.js");
const H = 3600 * 1000;
...
module.exports = { campusAdmission, windowStatus };
```
...
```javascript
const { compareCampusJobs, compareCompanyCards } = require("../lib/campus-zone.js");
...
module.exports = { campusAdmission, windowStatus, compareCampusJobs, compareCompanyCards, WINDOW_ORDER };
```
...
```javascript
const { groupCampusJobs } = require("../lib/campus-zone.js");
...
module.exports = { campusAdmission, windowStatus, compareCampusJobs, compareCompanyCards, WINDOW_ORDER, groupCampusJobs };
```
