          ...
          {(jobs || []).map((job: any) => (
            <div key={job.id} className="surface surface-hover p-5 text-[#1a1714]">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <a href={job.jd_url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#1a1714] px-4 py-2 text-sm font-semibold text-[#f7f1e6] transition duration-200 hover:bg-[#2b2520] active:scale-[0.98]">
                  查看官网
