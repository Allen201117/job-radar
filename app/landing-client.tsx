      ...
      <section id="why" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {PILLARS.map((p, i) => (
            <article
              key={p.title}
              className="lp-tilt lp-reveal bento-glow rounded-[22px] border border-black/[0.06] bg-white/70 p-6 hover:bg-white dark:border-white/[0.08] dark:bg-white/[0.04] dark:hover:bg-white/[0.07]"
